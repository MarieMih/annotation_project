...
def pipeline_since_fastq(directory):
    ...
    for i in files:
        ...
        annotation_tsv = os.path.split(i)[0] + "/assembly_" + name + "_sub" + "/bakta_annotation/" + name[-24:] + ".tsv"
        annotation(annotation_tsv)
        annotation_tsv = os.path.split(i)[0] + "/assembly_" + name + "_sub" + "/bakta_annotation/" + name[-24:] + "_extended.tsv"
...
def pipeline_assembly_file(file):
    ...
    for i in files:
        ...
        annotation_tsv = os.path.split(i)[0] + "/bakta_annotation/" + name[-24:] + ".tsv"
        annotation(annotation_tsv)
        annotation_tsv = os.path.split(i)[0] + "/bakta_annotation/" + name[-24:] + "_extended.tsv"
        tsvs.append(annotation_tsv)
...
if __name__ == "__main__":
    pipeline_since_fastq(sys.argv[1])
